...
class DefaultNormalizer implements NormalizerInterface {
	...
	public static function clean($str, $cleanWhitespace = false) {
		...
		$r = str_replace($a, $b, $str);

		if ($cleanWhitespace)
		{
			$r = self::trimWhitespace($r, '_');
		}
	...
	public static function trimWhitespace($str, $replacement = '_') {
